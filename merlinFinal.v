...
Lemma revword w0:(fun w => langW (rev w0) w) =L (fun w => langW w0 (rev w)).
Proof.
split;unfold langW;move => L1.
- rewrite L1. apply rev_involutive.
- symmetry in L1. rewrite L1. symmetry. apply rev_involutive.
Qed.
